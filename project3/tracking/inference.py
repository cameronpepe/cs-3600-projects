...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        self.particles = []
        legalPositionsLength = len(self.legalPositions)
        for n in range(0, self.numParticles):
            self.particles.append(self.legalPositions[n % legalPositionsLength])
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance is None:
            ...
            for p in self.legalPositions:
                ...
                allPossible[p] = emissionModel[distance] * oldBeliefs[p]
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        possiblePositionsLength = len(possiblePositions)
        for n in range(self.numParticles):
            self.particles.append(possiblePositions[n % possiblePositionsLength])
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                if noisyDistances[i] == None:
                    ...
                    w *= emissionModels[i][distance]
            allPossible[particle] +=  w
